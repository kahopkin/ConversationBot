...
export class ConversationalBot extends TeamsActivityHandler {
   ...
   //the bot will respond to the message MentionMe in a 1:1 chat conversation. The response will mention the user who initiated the conversation.
  ...
  //implement the handler for support being added to a team and respond to messages from the Conversations tab.
